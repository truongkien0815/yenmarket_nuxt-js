...
const fetchProduct = async () => {
  try {
    ...
    if (error.value) {
      ...
      const fishseafoo_Products = data.value?.filter(product => product.category === 'FISH AND SEAFOOD') || []
      product_fishseafoo.value = fishseafoo_Products

       const frozenmeat_Products = data.value?.filter(product => product.category === 'FROZEN MEAT') || []
...
<template>
      ...
      <div class="col-md-8">
        <div class="banner-container">
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide"><img src="/images/Banner8.jpg" alt="Slide 1"></div>
            <div class="swiper-slide"><img src="/images/Banner8.jpg" alt="Slide 2"></div>
            <div class="swiper-slide"><img src="/images/Banner8.jpg" alt="Slide 3"></div>
          </div>
  ...
  <div class="banner_address">
    <img src="https://mastererp.mylifecompany.com/Resources/Images/Object/Banner9114012025041546_S.jpg" alt="">
  </div>
  <div class="product">
    <div  class="subcate-name fz-xxl color-title fw-bold my-3">FISH AND SEAFOOD</div>
 ...
 <div class="image-product">
  ...
  <div class="card-bodyf">
    ...
    <p class="card-price"><b>{{item.price}} /</b>{{item.unit}}</p>
 ...
 <div  class="btn-seemore py-4 w-100 d-flex align-items-center justify-content-center">
  <div  class="style-button">
    <div  class="btn ">Xem tất cả</div></div></div>
  </div>

  <div class="product">
    <div  class="subcate-name fz-xxl color-title fw-bold my-3">FROZEN MEAT</div>
   <div v-if="loading">Đang tải dữ liệu...</div>
  <div v-else-if="errorMsg">{{ errorMsg }}</div>
  <div v-else class="product-list">
